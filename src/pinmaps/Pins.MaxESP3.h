...
#define Aux1                  2     // OneWire, Aux, Tone etc.
#define Aux2                  15    // PEC, Limit, Tone etc.

// Misc. pins
#ifndef OneWirePin
  #define OneWirePin          25     
#endif
#define AddonBootModePin      Aux2     // 26 ESP8266 GPIO0
#define AddonResetPin         Aux1     // aux2 ESP8266 RST 
...
#define LEDnegPin             19      // Drain Aux8
#define ReticlePin            Aux1    // Aux1     // Drain Aux8

// For a piezo buzzer
#ifndef TonePin
  #define TonePin             -1      // Tone
#endif

// The PPS pin is a 3.3V logic input, OnStep measures time between rising edges and adjusts the internal sidereal clock frequency
#define PpsPin                39      // PPS time source, GPS for example

#define LimitPin              Aux2    // aux2 The limit switch sense is a logic level input normally pull high (2k resistor,) shorted to ground it stops gotos/tracking
